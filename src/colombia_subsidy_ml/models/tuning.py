...
def tune_stage1_classifier(
    *,
    ...
    if best_result is None:
        ...
        fallback_proba = fallback_model.predict_proba(X_val)[:, 1]
        fallback_pred = (fallback_proba >= stage_threshold).astype(int)
        fallback_metrics = compute_binary_metrics(y_val, fallback_pred, y_proba=fallback_proba)
